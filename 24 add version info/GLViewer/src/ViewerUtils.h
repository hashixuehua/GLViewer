...
public:
    ...
    static void getWCSRectSelectBox(const Vector2f& ptS, const Vector2f& ptE, const QRect& viewport_rect, const QMatrix4x4& modelInvert,
        const QMatrix4x4& viewInvert, const QMatrix4x4& projectionInvert, Body& box);
    static void getWCSRectSelect(const Vector2f& ptS, const Vector2f& ptE, double depth, const QRect& viewport_rect, const QMatrix4x4& modelInvert,
        const QMatrix4x4& viewInvert, const QMatrix4x4& projectionInvert, vector<Vector3f>& rect);
    static Transform getRectSelectMatrix(const vector<Vector3f>& rectData);
