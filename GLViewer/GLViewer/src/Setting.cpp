...
QVector4D Setting::wireframeColor = QVector4D(0.f, 0.f, 0.f, 1.f);
QVector4D Setting::snapColor = QVector4D(1.0, 0.0, 1.0, 1.0);;
QVector4D Setting::rectBoxColor = QVector4D(1.0, 0.0, 1.0, 1.0);;
