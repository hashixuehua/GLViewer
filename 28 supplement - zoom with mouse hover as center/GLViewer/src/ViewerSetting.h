...
public:
    //  call back
    static std::function<void(bool, int)> OnMSAAModelChanged;
    static std::function<void(bool, bool)> OnEdgeLineModeChanged;
...
public:
    ...
    static bool showEdgeLine;
    static bool edgeLinePPAA;

    //  wireframe mode
    static bool wireframeMode;

    //  mouse scale mode
    static bool mouseScaleByCenter;
