...
{
public:
    ModelNode() : nodeType(GLNodeType::GLUnKnown), curveId(nullptr) {}
    ModelNode(GLNodeType nType, const Vector3f& pt, const CurveData* curvId) : nodeType(nType), point(pt), curveId(curvId) {}

public:
    GLNodeType nodeType;
    Vector3f point;
    const CurveData* curveId;
};
